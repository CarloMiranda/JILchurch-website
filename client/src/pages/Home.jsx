...
function Home() {
    ...
    <div className='home'>
       <div className="banner">
            <div className="banner-image w-100 vh-100"></div>
       </div>
        ...
        <div className="parallax w-100 vh-100">
            <div className="parallax-hero vh-100">
                <div className="home-content fs-5 text-white">
                    ...
                    <a href="" className="btn rounded border border-white text-white">Learn More</a>
                </div>
            </div>
        </div>
